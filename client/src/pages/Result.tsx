    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-20">
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          <h1>Generations Result</h1>
          <Link
            to="/generate"
            className="btn-secondary text-sm flex items-center gap-2"
          >
            <RefreshCwIcon className="w-4 h-4" />
            <p className="max-sm:hidden">New Generations</p>
          </Link>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-panel inline-block p-2 rounded-2xl">
              <div
                className={`${project?.aspectRatio === "9:16" ? "aspect-9/16" : "aspect-video"} sm:max-h-200 rounded-lg bg-gray-900 overflow-hidden relative `}
              >
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Turn this static page into a dynamic video for social media.
              </p>
              {!project.generatedVideo ? (
                <PrimaryButton
                ...
                <div className="p-3 rounded-xl bg-green-500/10 border border-green-500/20 text-green-400 text-center text-sm font-medium">
